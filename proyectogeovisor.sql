...
BEGIN
    IF (TG_OP = 'DELETE') THEN
        INSERT INTO auditoria_usuarios (usu_id, accion, usuario_accion, datos_antiguos)
        VALUES (OLD.usu_id, 'DELETE', current_setting('app.current_user')::integer, row_to_json(OLD));
    ELSIF (TG_OP = 'UPDATE') THEN
        INSERT INTO auditoria_usuarios (usu_id, accion, usuario_accion, datos_antiguos, datos_nuevos)
        VALUES (NEW.usu_id, 'UPDATE', current_setting('app.current_user')::integer, row_to_json(OLD), row_to_json(NEW));
    ELSIF (TG_OP = 'INSERT') THEN
        INSERT INTO auditoria_usuarios (usu_id, accion, usuario_accion, datos_nuevos)
        VALUES (NEW.usu_id, 'INSERT', current_setting('app.current_user')::integer, row_to_json(NEW));
    END IF;
    RETURN NULL;
END;
$$ LANGUAGE plpgsql;
...
BEGIN
    ...
    ELSIF (TG_OP = 'UPDATE') THEN
        INSERT INTO auditoria_reportes_accidentes (reporte_id, accion, usuario_accion, datos_antiguos, datos_nuevos)
        VALUES (NEW.reporte_id, 'UPDATE', current_setting('app.current_user')::integer, row_to_json(OLD), row_to_json(NEW));
    ELSIF (TG_OP = 'INSERT') THEN
        INSERT INTO auditoria_reportes_accidentes (reporte_id, accion, usuario_accion, datos_nuevos)
